#' Package Options
#'
#' The rsconnect package supports several options that control the method used
#' for http communications, the printing of diagnostic information for http
#' requests, and the launching of an external browser after deployment.
#'
#' @details
...
#' startup scripts. This can make it challenging to ensure options are set
#' properly prior to push-button deployment, so the rsconnect package has a
#' parallel set of "startup" scripts it runs prior to deploying. The following
