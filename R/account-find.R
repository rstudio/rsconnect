  ...
  if (nrow(accounts) == 0) {
    cli::cli_abort(
      c(
        ...
        i = "To register an account, call {.fun rsconnect::connectCloudUser} (Posit Connect Cloud), {.fun rsconnect::connectUser} (Posit Connect), or {.fun rsconnect::setAccountInfo} (shinyapps.io)."
      ),
      call = error_call
    )
  }
