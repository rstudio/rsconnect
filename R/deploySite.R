...
#' @param recordDir The default, `NULL`, uses `siteDir`, since this is usually
#'   where you want to record the deployment data.
#' @param ... Additional arguments to [deployApp()]. Do not supply `appDir`
#'   or `appFiles`; these three parameters are automatically generated by
#'   `deploySite`.
#'
