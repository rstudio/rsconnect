# New .rscignore functionality tests - gitignore-style patterns and hierarchical behavior
# These tests cover features not present in the main branch

# =============================================================================
# GITIGNORE-STYLE PATTERN TESTS
# =============================================================================
...
# =============================================================================
# LEGACY MODE AND BEHAVIORAL COMPARISON TESTS
# =============================================================================
...
test_that("gitignore-style patterns work correctly in hierarchical mode", {
  dir <- local_temp_app()
...
test_that("parameter validation and option handling", {
  ...
  withr::local_options(rsconnect.rscignore.legacy = TRUE)
  expect_no_error(suppressWarnings(bundleFiles(dir)))  # Test that legacy mode works without error
  ...
  expect_no_error(suppressWarnings(bundleFiles(dir)))  # Should convert to TRUE and work
}) 