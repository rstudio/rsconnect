...
An R package used for deploying applications to the [ShinyApps](https://www.shinyapps.io/)
and [Posit Cloud](https://www.posit.cloud/) hosted services, or to [Posit Connect](https://www.posit.co/products/enterprise/connect/).
