...
- New
  [`migrateToConnectCloud()`](https://rstudio.github.io/rsconnect/reference/migrateToConnectCloud.md)
...
- [`deployApp()`](https://rstudio.github.io/rsconnect/reference/deployApp.md)’s
...
- New `rsconnect.http.headers` and `rsconnect.http.cookies` allow you to
  ...
  [`vignette("custom-http")`](https://rstudio.github.io/rsconnect/articles/custom-http.md).
...
- New
  ...
  which supsersedes
  [`listBundleFiles()`](https://rstudio.github.io/rsconnect/reference/listBundleFiles.md).
